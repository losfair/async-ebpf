...
pub use crate::coroutine::arch::TrapHandlerRegs;
use crate::coroutine::stack::StackPointer;
use crate::coroutine::unwind::initial_func_abi;
#[cfg(doc)]
use crate::coroutine::ScopedCoroutine; // For rustdoc to resolve doc-links
use crate::coroutine::{arch, util};
    ...
    F: 'static,
  {
    initial_func_abi! {
        ...
        unsafe fn trap_handler<F: FnOnce() -> Return, Return>(
            ...
            let result = crate::coroutine::unwind::catch_unwind_at_root(f.read());
